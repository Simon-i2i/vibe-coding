...
public class BubbleSortTests : IClassFixture<SortingTestFixture>
{
    private readonly BubbleSort _sorter;

    public BubbleSortTests(SortingTestFixture fixture)
    {
        _sorter = fixture.ServiceProvider.GetRequiredService<BubbleSort>();
    }
